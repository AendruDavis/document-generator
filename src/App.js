        ...
        <div className="max-w-7xl mx-auto px-8 py-5">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-white tracking-tight">Galene Document Generator</h1>
                {/* <p className="text-xs text-emerald-100">Professional invoicing system</p> */}
              </div>
            </div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {['quotation', 'invoice', 'receipt', 'letter'].map((type) => (
                    <button
                      ...
                      className={`px-4 py-3 rounded-md text-sm font-semibold transition-all ${documentType === type
                ...
                <div className="bg-white rounded-lg shadow-sm border border-stone-200 p-6">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`flex-1 px-4 py-3 rounded-md text-sm font-semibold transition-all ${currency === 'USD'
                    ...
                    <button
                      ...
                      className={`flex-1 px-4 py-3 rounded-md text-sm font-semibold transition-all ${currency === 'UGX'
                        ? 'bg-amber-500 text-white shadow-md'
                        : 'bg-stone-100 text-stone-700 hover:bg-stone-200'
                      }`}
                    >
